...
public class UserServiceImpl implements UserService {
    ...
    public void addDefaultUser() {
        ...
        User user1 = new User("Eugene","Kalinichev",(byte) 22, "admin@mail.com", "eugene","12345",roles2);
        User user2 = new User("Victor","Martwasd",(byte) 22, "user@mail.com", "viktor","user1",roles1);
        save(user1);
        save(user2);
        }
}
